...
class TestVmap:
    ...
    def test_vmap_solve_bvp(self):
        ...
        from torchscience.integration import solve_bvp
    ...
    def test_vmap_bvp_solution_call(self):
        ...
        from torchscience.integration import BVPSolution
    ...
    def test_hermite_interpolate_vmappable(self):
        ...
        from torchscience.integration._interpolation import hermite_interpolate
