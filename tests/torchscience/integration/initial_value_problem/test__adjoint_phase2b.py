...
class TestSparseJacobian:
    ...
    def test_sparse_coloring(self):
        ...
        from torchscience.integration.initial_value_problem._sparse_jacobian import (
            compute_coloring,
        )
...
class TestCNFUtilities:
    ...
    def test_exact_trace(self):
        ...
        from torchscience.integration.initial_value_problem import exact_trace
    ...
    def test_cnf_dynamics_wrapper(self):
        ...
        from torchscience.integration.initial_value_problem import cnf_dynamics
