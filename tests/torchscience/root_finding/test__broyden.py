...
class TestBroydenVmap:
    """Tests for vmap compatibility.

    Note: vmap is currently NOT compatible with broyden due to:
    ...
    (e.g., broyden(f, batched_x0)) instead of vmap for vectorized computation.
    """
    ...
    def test_vmap_basic(self):
        """vmap works with broyden for vectorized parameter sweeps."""
    ...
    def test_explicit_batching_alternative(self):
        ...
        Instead of using vmap, pass batched inputs directly to broyden.
        """
