...
class TestHalleyCompile:
    ...
    def test_compile_eager_backend(self):
        """torch.compile with eager backend works with halley."""
    ...
    def test_compile_inductor_backend(self):
        """torch.compile with inductor backend works with halley."""
        c = torch.tensor([2.0, 3.0, 4.0])
    ...
    def test_compile_explicit_derivatives(self):
        """torch.compile works with explicit derivative functions."""
        c = torch.tensor([2.0, 3.0, 4.0])
