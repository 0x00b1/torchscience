...
class TestCosineWave:
    ...
    def test_starts_at_one(self):
        ...
        result = torchscience.waveform.cosine_wave(n=100, sample_rate=100.0)
    ...
    def test_equals_sine_with_phase_shift(self):
        """cos(x) = sin(x + pi/2)."""
        n = 100
        cosine = torchscience.waveform.cosine_wave(
            n=n, frequency=1.0, sample_rate=100.0, dtype=torch.float64
        )
        sine_shifted = torchscience.waveform.sine_wave(
            n=n,
            frequency=1.0,
            sample_rate=100.0,
            phase=math.pi / 2,
    ...
    def test_tensor_parameters(self):
        ...
        result = torchscience.waveform.cosine_wave(
