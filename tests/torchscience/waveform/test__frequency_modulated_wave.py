...
class TestFrequencyModulatedWave:
    def test_basic_shape(self):
        result = torchscience.waveform.frequency_modulated_wave(
            n=1000,
    ...
    def test_phase_offset(self):
        result_no_phase = torchscience.waveform.frequency_modulated_wave(
            n=1000,
            carrier_frequency=100.0,
            modulator_frequency=5.0,
            modulation_index=1.0,
        ...
        result_with_phase = torchscience.waveform.frequency_modulated_wave(
            n=1000,
            carrier_frequency=100.0,
            modulator_frequency=5.0,
            modulation_index=1.0,
    ...
    def test_mutual_exclusivity_n_t(self):
        with pytest.raises(ValueError, match="mutually exclusive"):
            torchscience.waveform.frequency_modulated_wave(
                n=1000,
                t=torch.linspace(0, 1, 1000),
                carrier_frequency=100.0,
                modulator_frequency=5.0,
