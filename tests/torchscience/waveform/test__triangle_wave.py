...
class TestTriangleWave:
    def test_basic_shape(self):
        result = torchscience.waveform.triangle_wave(n=100, sample_rate=100.0)
        assert result.shape == (100,)

    def test_amplitude_range(self):
        result = torchscience.waveform.triangle_wave(
    ...
    def test_empty_n(self):
        result = torchscience.waveform.triangle_wave(n=0, sample_rate=100.0)
        assert result.shape == (0,)

    def test_single_sample(self):
        result = torchscience.waveform.triangle_wave(n=1, sample_rate=100.0)
        assert result.shape == (1,)

    def test_mutually_exclusive_n_t(self):
        with pytest.raises(ValueError):
            torchscience.waveform.triangle_wave(
    ...
    def test_with_time_tensor(self):
        ...
        result = torchscience.waveform.triangle_wave(t=t, frequency=5.0)
        assert result.shape == (100,)
