...
def batched_butterworth_design(
    ...
    *,
    ...
    --------
    >>> import torch
    >>> from torchscience.filter_design import batched_butterworth_design
...
def batched_chebyshev_type_1_design(
    ...
    *,
    ...
    --------
    >>> import torch
    >>> from torchscience.filter_design import batched_chebyshev_type_1_design
...
def batched_chebyshev_type_2_design(
    ...
    *,
    ...
    --------
    >>> import torch
    >>> from torchscience.filter_design import batched_chebyshev_type_2_design
    >>> cutoffs = torch.linspace(0.1, 0.4, 5)
...
def batched_firwin(
    ...
    *,
    ...
    --------
    >>> import torch
    >>> from torchscience.filter_design import batched_firwin
    >>> cutoffs = torch.linspace(0.1, 0.4, 10)
