...
def chebyshev_type_1_minimum_order(
    ...
    """
    Compute minimum Chebyshev Type I filter order for given specifications.

    Returns the lowest order digital Chebyshev Type I filter that loses no more
    ...
    The cutoff frequency is the passband edge where the ripple is at its maximum.
    ...
    if filter_type == "lowpass":
        # Passband edge normalized to 1, stopband edge relative
    ...
    # Compute order using Chebyshev formula
