"""Butterworth digital filter design function."""
...
def butterworth_design(
    ...
    *,
    ...
    --------
    >>> import torch
    >>> from torchscience.signal_processing.filter import butterworth_design
    >>> sos = butterworth_design(4, 0.3)  # 4th order lowpass at 0.3 * Nyquist
    >>> sos.shape
    torch.Size([2, 6])
    ...
    >>> sos = butterworth_design(4, 100.0, sampling_frequency=1000.0)  # 100 Hz cutoff at 1000 Hz sample rate
    """
    ...
    z_analog, p_analog, k_analog = butterworth_prototype(
