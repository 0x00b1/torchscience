...
namespace torchscience::sparse::coo::cpu::transform {

/**
 * Sparse COO CPU implementation of discrete wavelet transform.
 *
...
inline at::Tensor discrete_wavelet_transform(
    ...
    TORCH_CHECK(
        input.is_sparse(),
        "discrete_wavelet_transform (SparseCPU) expects sparse COO tensor"
    );
...
/**
 * Backward pass for sparse COO CPU discrete wavelet transform.
 */
inline at::Tensor discrete_wavelet_transform_backward(
    ...
    TORCH_CHECK(
        input.is_sparse(),
        "discrete_wavelet_transform_backward (SparseCPU) expects sparse COO tensor for input"
    );
...
/**
 * Double backward pass for sparse COO CPU discrete wavelet transform.
 */
...
TORCH_LIBRARY_IMPL(torchscience, SparseCPU, module) {
    module.impl(
        ...
        &torchscience::sparse::coo::cpu::transform::discrete_wavelet_transform
    );
    module.impl(
        "discrete_wavelet_transform_backward",
        &torchscience::sparse::coo::cpu::transform::discrete_wavelet_transform_backward
    );
    module.impl(
        "discrete_wavelet_transform_backward_backward",
        &torchscience::sparse::coo::cpu::transform::discrete_wavelet_transform_backward_backward
    );
}
