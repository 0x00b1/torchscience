...
namespace torchscience::sparse::coo::cuda::transform {

/**
 * Sparse COO CUDA implementation of discrete wavelet transform.
 *
...
inline at::Tensor discrete_wavelet_transform(
    ...
    TORCH_CHECK(
        ...
        "discrete_wavelet_transform (SparseCUDA) expects sparse COO CUDA tensor"
    );
...
/**
 * Backward pass for sparse COO CUDA discrete wavelet transform.
 */
inline at::Tensor discrete_wavelet_transform_backward(
    ...
    TORCH_CHECK(
        input.is_sparse() && input.is_cuda(),
        "discrete_wavelet_transform_backward (SparseCUDA) expects sparse COO CUDA tensor for input"
    );
...
/**
 * Double backward pass for sparse COO CUDA discrete wavelet transform.
 */
...
TORCH_LIBRARY_IMPL(torchscience, SparseCUDA, module) {
    module.impl(
        ...
        &torchscience::sparse::coo::cuda::transform::discrete_wavelet_transform
    );
    module.impl(
        "discrete_wavelet_transform_backward",
        &torchscience::sparse::coo::cuda::transform::discrete_wavelet_transform_backward
    );
    module.impl(
        "discrete_wavelet_transform_backward_backward",
        &torchscience::sparse::coo::cuda::transform::discrete_wavelet_transform_backward_backward
    );
}
