...
namespace torchscience::sparse::csr::cpu::transform {

/**
 * Sparse CSR CPU implementation of discrete wavelet transform.
 *
...
inline at::Tensor discrete_wavelet_transform(
    ...
    TORCH_CHECK(
        ...
        "discrete_wavelet_transform (SparseCsrCPU) expects sparse CSR tensor"
    );
...
/**
 * Backward pass for sparse CSR CPU discrete wavelet transform.
 */
inline at::Tensor discrete_wavelet_transform_backward(
    ...
    TORCH_CHECK(
        input.layout() == at::kSparseCsr,
        "discrete_wavelet_transform_backward (SparseCsrCPU) expects sparse CSR tensor for input"
    );
...
/**
 * Double backward pass for sparse CSR CPU discrete wavelet transform.
 */
...
TORCH_LIBRARY_IMPL(torchscience, SparseCsrCPU, module) {
    module.impl(
        ...
        &torchscience::sparse::csr::cpu::transform::discrete_wavelet_transform
    );
    module.impl(
        "discrete_wavelet_transform_backward",
        &torchscience::sparse::csr::cpu::transform::discrete_wavelet_transform_backward
    );
    module.impl(
        "discrete_wavelet_transform_backward_backward",
        &torchscience::sparse::csr::cpu::transform::discrete_wavelet_transform_backward_backward
    );
}
