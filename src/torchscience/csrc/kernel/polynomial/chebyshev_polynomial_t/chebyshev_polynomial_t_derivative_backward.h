...
// Backward pass for Chebyshev T polynomial derivative.
//
// Forward recurrence (from chebyshev_polynomial_t_derivative):
...
template <typename T>
void chebyshev_polynomial_t_derivative_backward(
    T* grad_coeffs,
    const T* grad_output,
    int64_t N,
    int64_t output_size
