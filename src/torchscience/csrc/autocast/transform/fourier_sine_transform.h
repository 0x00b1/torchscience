...
/**
 * Autocast wrapper for fourier_sine_transform (DST).
 */
...
TORCH_LIBRARY_IMPL(torchscience, AutocastCPU, module) {
    module.impl(
        ...
        &torchscience::autocast::transform::fourier_sine_transform
    );
    module.impl(
        "fourier_sine_transform_backward",
        &torchscience::autocast::transform::fourier_sine_transform_backward
    );
}
