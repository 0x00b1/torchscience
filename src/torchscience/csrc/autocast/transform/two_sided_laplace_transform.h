...
TORCH_LIBRARY_IMPL(torchscience, AutocastCPU, module) {
    module.impl("two_sided_laplace_transform", &torchscience::autocast::transform::two_sided_laplace_transform);
    module.impl("two_sided_laplace_transform_backward", &torchscience::autocast::transform::two_sided_laplace_transform_backward);
}
