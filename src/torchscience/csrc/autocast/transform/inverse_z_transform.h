...
inline at::Tensor inverse_z_transform(
    ...
    at::Tensor n_out_cast = at::autocast::cached_cast(target_dtype, n_out);
    at::Tensor z_in_cast = at::autocast::cached_cast(target_dtype, z_in);
    ...
    return c10::Dispatcher::singleton()
        ...
        .call(input_cast, n_out_cast, z_in_cast, dim);
}
...
inline at::Tensor inverse_z_transform_backward(
    ...
    return c10::Dispatcher::singleton()
        ...
        .call(grad_cast, input_cast, n_out_cast, z_in_cast, dim);
}

}  // namespace torchscience::autocast::transform

TORCH_LIBRARY_IMPL(torchscience, AutocastCPU, module) {
    module.impl("inverse_z_transform", &torchscience::autocast::transform::inverse_z_transform);
    module.impl("inverse_z_transform_backward", &torchscience::autocast::transform::inverse_z_transform_backward);
}
