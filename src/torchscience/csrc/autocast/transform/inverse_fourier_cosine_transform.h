...
/**
 * Autocast wrapper for inverse_fourier_cosine_transform (IDCT).
 */
...
TORCH_LIBRARY_IMPL(torchscience, AutocastCPU, module) {
    module.impl(
        ...
        &torchscience::autocast::transform::inverse_fourier_cosine_transform
    );
    module.impl(
        "inverse_fourier_cosine_transform_backward",
        &torchscience::autocast::transform::inverse_fourier_cosine_transform_backward
    );
}
