...
inline at::Tensor hankel_transform(
    ...
    at::Tensor k_out_cast = at::autocast::cached_cast(target_dtype, k_out);
    ...
    return c10::Dispatcher::singleton()
        ...
        .call(input_cast, k_out_cast, r_in_cast, dim, order, integration_method);
}
...
inline at::Tensor hankel_transform_backward(
    ...
    return c10::Dispatcher::singleton()
        ...
        .call(grad_cast, input_cast, k_out_cast, r_in_cast, dim, order, integration_method);
}

}  // namespace torchscience::autocast::transform

TORCH_LIBRARY_IMPL(torchscience, AutocastCPU, module) {
    module.impl("hankel_transform", &torchscience::autocast::transform::hankel_transform);
    module.impl("hankel_transform_backward", &torchscience::autocast::transform::hankel_transform_backward);
}
