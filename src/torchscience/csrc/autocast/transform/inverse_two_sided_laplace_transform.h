...
inline at::Tensor inverse_two_sided_laplace_transform(
    ...
    return c10::Dispatcher::singleton()
        ...
        .call(input_cast, t_out_cast, s_in_cast, dim, sigma, integration_method);
}
...
inline at::Tensor inverse_two_sided_laplace_transform_backward(
    ...
    return c10::Dispatcher::singleton()
        ...
        .call(grad_cast, input_cast, t_out_cast, s_in_cast, dim, sigma, integration_method);
}

}  // namespace torchscience::autocast::transform

TORCH_LIBRARY_IMPL(torchscience, AutocastCPU, module) {
    module.impl("inverse_two_sided_laplace_transform", &torchscience::autocast::transform::inverse_two_sided_laplace_transform);
    module.impl("inverse_two_sided_laplace_transform_backward", &torchscience::autocast::transform::inverse_two_sided_laplace_transform_backward);
}
