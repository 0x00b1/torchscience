...
/**
 * Autocast wrapper for fourier_cosine_transform (DCT).
 */
...
TORCH_LIBRARY_IMPL(torchscience, AutocastCPU, module) {
    module.impl(
        ...
        &torchscience::autocast::transform::fourier_cosine_transform
    );
    module.impl(
        "fourier_cosine_transform_backward",
        &torchscience::autocast::transform::fourier_cosine_transform_backward
    );
}
