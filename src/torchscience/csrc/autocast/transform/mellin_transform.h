...
TORCH_LIBRARY_IMPL(torchscience, AutocastCPU, module) {
    module.impl("mellin_transform", &torchscience::autocast::transform::mellin_transform);
    module.impl("mellin_transform_backward", &torchscience::autocast::transform::mellin_transform_backward);
}
