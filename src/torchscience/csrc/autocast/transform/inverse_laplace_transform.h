...
TORCH_LIBRARY_IMPL(torchscience, AutocastCPU, module) {
    module.impl("inverse_laplace_transform", &torchscience::autocast::transform::inverse_laplace_transform);
    module.impl("inverse_laplace_transform_backward", &torchscience::autocast::transform::inverse_laplace_transform_backward);
}
