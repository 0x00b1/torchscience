...
inline at::Tensor legendre_polynomial_p_multiply(const at::Tensor& a, const at::Tensor& b) {
...
TORCH_LIBRARY_IMPL(torchscience, Autocast, m) {
    m.impl("legendre_polynomial_p_multiply", &torchscience::autocast::polynomial::legendre_polynomial_p_multiply);
}
