...
#include "../../kernel/information_theory/directed_information.h"
#include "../../kernel/information_theory/directed_information_backward.h"

namespace torchscience::cpu::information_theory {

namespace {

inline at::Tensor di_preprocess_input(
...
inline at::Tensor di_apply_reduction(
...
inline double di_get_log_base_scale(c10::optional<double> base) {
    if (!base.has_value()) {
        return 1.0;
    }
    double b = base.value();
...
inline at::Tensor directed_information(
    ...
    at::Tensor joint_prob = di_preprocess_input(joint, input_type);
    double log_base_scale = di_get_log_base_scale(base);
        ...
        [&]() {
            ...
            at::parallel_for(0, batch_size, 0, [&](int64_t begin, int64_t end) {
                ...
                for (int64_t idx = begin; idx < end; ++idx) {
                    ...
                    // p_yprev = sum over yt and xt
                    // p_yprev_xt = sum over yt
                    // p_yt_yprev = sum over xt
                    ...
                    out_ptr[idx] = torchscience::kernel::information_theory::directed_information_kernel<scalar_t>(
                        batch_joint,
                        p_yprev_xt.data(),
                        p_yt_yprev.data(),
                        p_yprev.data(),
    ...
    return di_apply_reduction(output, reduction);
}
...
inline at::Tensor directed_information_backward(
    ...
    AT_DISPATCH_FLOATING_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        joint_prob.scalar_type(),
        "directed_information_backward_cpu",
        [&]() {
            const scalar_t* joint_ptr = joint_t.data_ptr<scalar_t>();
            ...
            at::parallel_for(0, batch_size, 0, [&](int64_t begin, int64_t end) {
                ...
                for (int64_t idx = begin; idx < end; ++idx) {
                    ...
                    torchscience::kernel::information_theory::directed_information_backward_kernel<scalar_t>(
                        grad_val,
                        batch_joint,
                        p_yprev_xt.data(),
                        p_yt_yprev.data(),
...
TORCH_LIBRARY_IMPL(torchscience, CPU, m) {
    m.impl("directed_information", &torchscience::cpu::information_theory::directed_information);
    m.impl("directed_information_backward", &torchscience::cpu::information_theory::directed_information_backward);
}
