...
#include "../../../kernel/polynomial/chebyshev_polynomial_w/chebyshev_polynomial_w_multiply.h"
#include "../../../kernel/polynomial/chebyshev_polynomial_w/chebyshev_polynomial_w_multiply_backward.h"
#include "../../../kernel/polynomial/chebyshev_polynomial_w/chebyshev_polynomial_w_multiply_backward_backward.h"
        ...
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t batch = start; batch < end; ++batch) {
                    ...
                    kernel::polynomial::chebyshev_polynomial_w_multiply(
...
inline std::tuple<at::Tensor, at::Tensor> chebyshev_polynomial_w_multiply_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        a.scalar_type(),
        "chebyshev_polynomial_w_multiply_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t batch = start; batch < end; ++batch) {
                    ...
                    kernel::polynomial::chebyshev_polynomial_w_multiply_backward(
                        grad_a_ptr + batch * N,
                        grad_b_ptr + batch * M,
...
chebyshev_polynomial_w_multiply_backward_backward(
        ...
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t batch = start; batch < end; ++batch) {
                    ...
                    kernel::polynomial::chebyshev_polynomial_w_multiply_backward_backward(
...
TORCH_LIBRARY_IMPL(torchscience, CPU, module) {
    module.impl("chebyshev_polynomial_w_multiply", torchscience::cpu::polynomial::chebyshev_polynomial_w_multiply);
    module.impl("chebyshev_polynomial_w_multiply_backward", torchscience::cpu::polynomial::chebyshev_polynomial_w_multiply_backward);
    module.impl("chebyshev_polynomial_w_multiply_backward_backward", torchscience::cpu::polynomial::chebyshev_polynomial_w_multiply_backward_backward);
}
