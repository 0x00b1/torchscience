...
#include "../../../kernel/polynomial/legendre_polynomial_p/legendre_polynomial_p_multiply.h"
#include "../../../kernel/polynomial/legendre_polynomial_p/legendre_polynomial_p_multiply_backward.h"
#include "../../../kernel/polynomial/legendre_polynomial_p/legendre_polynomial_p_multiply_backward_backward.h"

namespace torchscience::cpu::polynomial {

// Forward: a (B, N), b (B, M) -> output (B, N+M-1)
inline at::Tensor legendre_polynomial_p_multiply(
    const at::Tensor& a,
    const at::Tensor& b
) {
        ...
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t batch = start; batch < end; ++batch) {
                    kernel::polynomial::legendre_polynomial_p_multiply(
...
inline std::tuple<at::Tensor, at::Tensor> legendre_polynomial_p_multiply_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        a.scalar_type(),
        "legendre_polynomial_p_multiply_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t batch = start; batch < end; ++batch) {
                    kernel::polynomial::legendre_polynomial_p_multiply_backward(
                        grad_a_ptr + batch * N,
                        grad_b_ptr + batch * M,
...
inline std::tuple<at::Tensor, at::Tensor, at::Tensor> legendre_polynomial_p_multiply_backward_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        a.scalar_type(),
        "legendre_polynomial_p_multiply_backward_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t batch = start; batch < end; ++batch) {
                    kernel::polynomial::legendre_polynomial_p_multiply_backward_backward(
...
TORCH_LIBRARY_IMPL(torchscience, CPU, module) {
    module.impl("legendre_polynomial_p_multiply", torchscience::cpu::polynomial::legendre_polynomial_p_multiply);
    module.impl("legendre_polynomial_p_multiply_backward", torchscience::cpu::polynomial::legendre_polynomial_p_multiply_backward);
    module.impl("legendre_polynomial_p_multiply_backward_backward", torchscience::cpu::polynomial::legendre_polynomial_p_multiply_backward_backward);
}
