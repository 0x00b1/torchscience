...
#include "../../../kernel/polynomial/legendre_polynomial_p/legendre_polynomial_p_derivative.h"
#include "../../../kernel/polynomial/legendre_polynomial_p/legendre_polynomial_p_derivative_backward.h"
#include "../../../kernel/polynomial/legendre_polynomial_p/legendre_polynomial_p_derivative_backward_backward.h"
        ...
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::legendre_polynomial_p_derivative(
                        out_ptr + b * output_N,
                        coeffs_ptr + b * N,
                        N
                    );
...
inline at::Tensor legendre_polynomial_p_derivative_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        coeffs.scalar_type(),
        "legendre_polynomial_p_derivative_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::legendre_polynomial_p_derivative_backward(
                        grad_coeffs_ptr + b * N,
...
inline at::Tensor legendre_polynomial_p_derivative_backward_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        coeffs.scalar_type(),
        "legendre_polynomial_p_derivative_backward_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::legendre_polynomial_p_derivative_backward_backward(
                        ggo_ptr + b * output_N,
                        gg_coeffs_ptr + b * N,
                        N,
                        output_N
...
TORCH_LIBRARY_IMPL(torchscience, CPU, module) {
    module.impl("legendre_polynomial_p_derivative", torchscience::cpu::polynomial::legendre_polynomial_p_derivative);
    module.impl("legendre_polynomial_p_derivative_backward", torchscience::cpu::polynomial::legendre_polynomial_p_derivative_backward);
    module.impl("legendre_polynomial_p_derivative_backward_backward", torchscience::cpu::polynomial::legendre_polynomial_p_derivative_backward_backward);
}
