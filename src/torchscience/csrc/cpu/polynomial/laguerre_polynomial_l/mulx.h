...
#include "../../../kernel/polynomial/laguerre_polynomial_l/laguerre_polynomial_l_mulx.h"
#include "../../../kernel/polynomial/laguerre_polynomial_l/laguerre_polynomial_l_mulx_backward.h"
#include "../../../kernel/polynomial/laguerre_polynomial_l/laguerre_polynomial_l_mulx_backward_backward.h"
        ...
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::laguerre_polynomial_l_mulx(
                        out_ptr + b * output_N,
                        coeffs_ptr + b * N,
                        N
                    );
...
inline at::Tensor laguerre_polynomial_l_mulx_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        coeffs.scalar_type(),
        "laguerre_polynomial_l_mulx_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::laguerre_polynomial_l_mulx_backward(
                        grad_coeffs_ptr + b * N,
...
inline at::Tensor laguerre_polynomial_l_mulx_backward_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        coeffs.scalar_type(),
        "laguerre_polynomial_l_mulx_backward_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::laguerre_polynomial_l_mulx_backward_backward(
                        ggo_ptr + b * output_N,
                        gg_coeffs_ptr + b * N,
...
TORCH_LIBRARY_IMPL(torchscience, CPU, module) {
    module.impl("laguerre_polynomial_l_mulx", torchscience::cpu::polynomial::laguerre_polynomial_l_mulx);
    module.impl("laguerre_polynomial_l_mulx_backward", torchscience::cpu::polynomial::laguerre_polynomial_l_mulx_backward);
    module.impl("laguerre_polynomial_l_mulx_backward_backward", torchscience::cpu::polynomial::laguerre_polynomial_l_mulx_backward_backward);
}
