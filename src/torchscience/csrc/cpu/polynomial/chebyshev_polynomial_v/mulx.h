...
#include "../../../kernel/polynomial/chebyshev_polynomial_v/chebyshev_polynomial_v_mulx.h"
#include "../../../kernel/polynomial/chebyshev_polynomial_v/chebyshev_polynomial_v_mulx_backward.h"
#include "../../../kernel/polynomial/chebyshev_polynomial_v/chebyshev_polynomial_v_mulx_backward_backward.h"

namespace torchscience::cpu::polynomial {

// Forward: coeffs (B, N) -> output (B, N + 1)
inline at::Tensor chebyshev_polynomial_v_mulx(
        ...
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t batch = start; batch < end; ++batch) {
                    kernel::polynomial::chebyshev_polynomial_v_mulx(
...
inline at::Tensor chebyshev_polynomial_v_mulx_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        coeffs.scalar_type(),
        "chebyshev_polynomial_v_mulx_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t batch = start; batch < end; ++batch) {
                    kernel::polynomial::chebyshev_polynomial_v_mulx_backward(
...
chebyshev_polynomial_v_mulx_backward_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        ...
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t batch = start; batch < end; ++batch) {
                    kernel::polynomial::chebyshev_polynomial_v_mulx_backward_backward(
...
TORCH_LIBRARY_IMPL(torchscience, CPU, module) {
    module.impl("chebyshev_polynomial_v_mulx", torchscience::cpu::polynomial::chebyshev_polynomial_v_mulx);
    module.impl("chebyshev_polynomial_v_mulx_backward", torchscience::cpu::polynomial::chebyshev_polynomial_v_mulx_backward);
    module.impl("chebyshev_polynomial_v_mulx_backward_backward", torchscience::cpu::polynomial::chebyshev_polynomial_v_mulx_backward_backward);
}
