...
#include "../../../kernel/polynomial/chebyshev_polynomial_v/chebyshev_polynomial_v_derivative.h"
#include "../../../kernel/polynomial/chebyshev_polynomial_v/chebyshev_polynomial_v_derivative_backward.h"
#include "../../../kernel/polynomial/chebyshev_polynomial_v/chebyshev_polynomial_v_derivative_backward_backward.h"
        ...
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::chebyshev_polynomial_v_derivative(
                        out_ptr + b * output_N,
                        coeffs_ptr + b * N,
                        N
                    );
...
inline at::Tensor chebyshev_polynomial_v_derivative_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        coeffs.scalar_type(),
        "chebyshev_polynomial_v_derivative_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::chebyshev_polynomial_v_derivative_backward(
                        grad_coeffs_ptr + b * N,
...
inline at::Tensor chebyshev_polynomial_v_derivative_backward_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        coeffs.scalar_type(),
        "chebyshev_polynomial_v_derivative_backward_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::chebyshev_polynomial_v_derivative_backward_backward(
                        ggo_ptr + b * output_N,
                        gg_coeffs_ptr + b * N,
                        N,
                        output_N
...
TORCH_LIBRARY_IMPL(torchscience, CPU, module) {
    module.impl("chebyshev_polynomial_v_derivative", torchscience::cpu::polynomial::chebyshev_polynomial_v_derivative);
    module.impl("chebyshev_polynomial_v_derivative_backward", torchscience::cpu::polynomial::chebyshev_polynomial_v_derivative_backward);
    module.impl("chebyshev_polynomial_v_derivative_backward_backward", torchscience::cpu::polynomial::chebyshev_polynomial_v_derivative_backward_backward);
}
