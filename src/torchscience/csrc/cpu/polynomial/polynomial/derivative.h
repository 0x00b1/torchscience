...
#include "../../../kernel/polynomial/polynomial/polynomial_derivative.h"
#include "../../../kernel/polynomial/polynomial/polynomial_derivative_backward.h"
#include "../../../kernel/polynomial/polynomial/polynomial_derivative_backward_backward.h"

namespace torchscience::cpu::polynomial {

// Forward: coeffs (B, N) -> output (B, max(N-1, 1))
inline at::Tensor polynomial_derivative(const at::Tensor& coeffs) {
        ...
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::polynomial_derivative(
                        out_ptr + b * output_N,
                        coeffs_ptr + b * N,
                        N
                    );
...
inline at::Tensor polynomial_derivative_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        coeffs.scalar_type(),
        "polynomial_derivative_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::polynomial_derivative_backward(
                        grad_coeffs_ptr + b * N,
...
inline at::Tensor polynomial_derivative_backward_backward(
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
        at::kBFloat16, at::kHalf,
        coeffs.scalar_type(),
        "polynomial_derivative_backward_backward",
        [&] {
            ...
            at::parallel_for(0, B, 1, [&](int64_t start, int64_t end) {
                for (int64_t b = start; b < end; ++b) {
                    kernel::polynomial::polynomial_derivative_backward_backward(
                        ggo_ptr + b * output_N,
                        gg_coeffs_ptr + b * N,
                        N,
                        output_N
...
TORCH_LIBRARY_IMPL(torchscience, CPU, module) {
    module.impl("polynomial_derivative", torchscience::cpu::polynomial::polynomial_derivative);
    module.impl("polynomial_derivative_backward", torchscience::cpu::polynomial::polynomial_derivative_backward);
    module.impl("polynomial_derivative_backward_backward", torchscience::cpu::polynomial::polynomial_derivative_backward_backward);
}
