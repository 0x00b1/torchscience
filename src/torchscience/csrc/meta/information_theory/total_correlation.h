...
inline at::Tensor total_correlation(
    ...
    // Total correlation outputs a scalar (no batch support for now)
...
TORCH_LIBRARY_IMPL(torchscience, Meta, m) {
    m.impl("total_correlation", &torchscience::meta::information_theory::total_correlation);
    m.impl("total_correlation_backward", &torchscience::meta::information_theory::total_correlation_backward);
}
