...
TORCH_LIBRARY_IMPL(torchscience, Meta, m) {
    m.impl("transfer_entropy", &torchscience::meta::information_theory::transfer_entropy);
    m.impl("transfer_entropy_backward", &torchscience::meta::information_theory::transfer_entropy_backward);
}
