// src/torchscience/csrc/meta/linear_algebra/rank_revealing_qr.h
#pragma once
...
inline std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor> rank_revealing_qr(
    ...
    // rank: (...) - numerical rank (scalar per batch element)
    // info: (...) - convergence indicator
    ...
    return std::make_tuple(
        ...
        at::empty(batch_vec.empty() ? at::IntArrayRef({}) : batch_vec, a.options().dtype(at::kLong)),
...
TORCH_LIBRARY_IMPL(torchscience, Meta, m) {
    m.impl("rank_revealing_qr", &torchscience::meta::linear_algebra::rank_revealing_qr);
}
