...
polynomial_subtract_backward_backward(
...
TORCH_LIBRARY_IMPL(torchscience, Meta, module) {
    module.impl("polynomial_subtract", torchscience::meta::polynomial::polynomial_subtract);
    module.impl("polynomial_subtract_backward", torchscience::meta::polynomial::polynomial_subtract_backward);
    module.impl("polynomial_subtract_backward_backward", torchscience::meta::polynomial::polynomial_subtract_backward_backward);
}
