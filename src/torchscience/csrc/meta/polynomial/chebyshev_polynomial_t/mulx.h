...
TORCH_LIBRARY_IMPL(torchscience, Meta, module) {
    module.impl("chebyshev_polynomial_t_mulx", torchscience::meta::polynomial::chebyshev_polynomial_t_mulx);
    module.impl("chebyshev_polynomial_t_mulx_backward", torchscience::meta::polynomial::chebyshev_polynomial_t_mulx_backward);
    module.impl("chebyshev_polynomial_t_mulx_backward_backward", torchscience::meta::polynomial::chebyshev_polynomial_t_mulx_backward_backward);
}
