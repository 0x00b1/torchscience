...
TORCH_LIBRARY_IMPL(torchscience, Meta, module) {
    module.impl("chebyshev_polynomial_w_multiply", torchscience::meta::polynomial::chebyshev_polynomial_w_multiply);
    module.impl("chebyshev_polynomial_w_multiply_backward", torchscience::meta::polynomial::chebyshev_polynomial_w_multiply_backward);
    module.impl("chebyshev_polynomial_w_multiply_backward_backward", torchscience::meta::polynomial::chebyshev_polynomial_w_multiply_backward_backward);
}
