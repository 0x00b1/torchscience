...
TORCH_LIBRARY_IMPL(torchscience, Meta, module) {
    module.impl("hermite_polynomial_he_derivative", torchscience::meta::polynomial::hermite_polynomial_he_derivative);
    module.impl("hermite_polynomial_he_derivative_backward", torchscience::meta::polynomial::hermite_polynomial_he_derivative_backward);
    module.impl("hermite_polynomial_he_derivative_backward_backward", torchscience::meta::polynomial::hermite_polynomial_he_derivative_backward_backward);
}
