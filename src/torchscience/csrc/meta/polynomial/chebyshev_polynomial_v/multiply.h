...
TORCH_LIBRARY_IMPL(torchscience, Meta, module) {
    module.impl("chebyshev_polynomial_v_multiply", torchscience::meta::polynomial::chebyshev_polynomial_v_multiply);
    module.impl("chebyshev_polynomial_v_multiply_backward", torchscience::meta::polynomial::chebyshev_polynomial_v_multiply_backward);
    module.impl("chebyshev_polynomial_v_multiply_backward_backward", torchscience::meta::polynomial::chebyshev_polynomial_v_multiply_backward_backward);
}
