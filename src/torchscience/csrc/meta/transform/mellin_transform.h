...
/**
 * Meta implementation of Mellin transform for shape inference.
 */
...
TORCH_LIBRARY_IMPL(torchscience, Meta, module) {
    module.impl(
        "mellin_transform",
        &torchscience::meta::transform::mellin_transform
    );

    module.impl(
        "mellin_transform_backward",
        &torchscience::meta::transform::mellin_transform_backward
    );

    module.impl(
        "mellin_transform_backward_backward",
        &torchscience::meta::transform::mellin_transform_backward_backward
    );
}
