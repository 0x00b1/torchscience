...
/**
 * Meta implementation of DCT for shape inference.
 */
...
inline at::Tensor inverse_fourier_cosine_transform(
    ...
    return fourier_cosine_transform(input, n_param, dim, type, norm);
}
...
inline at::Tensor inverse_fourier_cosine_transform_backward(
    ...
    return fourier_cosine_transform_backward(grad_output, input, n_param, dim, type, norm);
}
...
inline std::tuple<at::Tensor, at::Tensor> inverse_fourier_cosine_transform_backward_backward(
    ...
    return fourier_cosine_transform_backward_backward(grad_grad_input, grad_output, input, n_param, dim, type, norm);
}
...
TORCH_LIBRARY_IMPL(torchscience, Meta, module) {
    module.impl(
        ...
        &torchscience::meta::transform::fourier_cosine_transform
    );

    module.impl(
        "fourier_cosine_transform_backward",
        &torchscience::meta::transform::fourier_cosine_transform_backward
    );

    module.impl(
        "fourier_cosine_transform_backward_backward",
        &torchscience::meta::transform::fourier_cosine_transform_backward_backward
    );

    module.impl(
        "inverse_fourier_cosine_transform",
        &torchscience::meta::transform::inverse_fourier_cosine_transform
    );

    module.impl(
        "inverse_fourier_cosine_transform_backward",
        &torchscience::meta::transform::inverse_fourier_cosine_transform_backward
    );

    module.impl(
        "inverse_fourier_cosine_transform_backward_backward",
        &torchscience::meta::transform::inverse_fourier_cosine_transform_backward_backward
    );
}
