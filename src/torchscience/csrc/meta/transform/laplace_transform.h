...
/**
 * Meta implementation of Laplace transform for shape inference.
 */
...
TORCH_LIBRARY_IMPL(torchscience, Meta, module) {
    module.impl(
        "laplace_transform",
        &torchscience::meta::transform::laplace_transform
    );

    module.impl(
        "laplace_transform_backward",
        &torchscience::meta::transform::laplace_transform_backward
    );

    module.impl(
        "laplace_transform_backward_backward",
        &torchscience::meta::transform::laplace_transform_backward_backward
    );
}
