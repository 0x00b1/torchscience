...
/**
 * Meta implementation of inverse Laplace transform for shape inference.
 */
...
TORCH_LIBRARY_IMPL(torchscience, Meta, module) {
    module.impl(
        ...
        &torchscience::meta::transform::inverse_laplace_transform
    );

    module.impl(
        "inverse_laplace_transform_backward",
        &torchscience::meta::transform::inverse_laplace_transform_backward
    );

    module.impl(
        "inverse_laplace_transform_backward_backward",
        &torchscience::meta::transform::inverse_laplace_transform_backward_backward
    );
}
