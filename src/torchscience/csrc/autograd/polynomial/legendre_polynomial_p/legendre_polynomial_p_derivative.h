...
class LegendrePolynomialPDerivativeBackward
    : public torch::autograd::Function<LegendrePolynomialPDerivativeBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_derivative_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_grad_output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_derivative_backward_backward", "")
            .typed<at::Tensor(const at::Tensor&, const at::Tensor&)>()
...
class LegendrePolynomialPDerivative
    : public torch::autograd::Function<LegendrePolynomialPDerivative> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* ctx,
        const at::Tensor& coeffs
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_derivative", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_coeffs = LegendrePolynomialPDerivativeBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor legendre_polynomial_p_derivative(const at::Tensor& coeffs) {
    return LegendrePolynomialPDerivative::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("legendre_polynomial_p_derivative", &torchscience::autograd::polynomial::legendre_polynomial_p_derivative);
}
