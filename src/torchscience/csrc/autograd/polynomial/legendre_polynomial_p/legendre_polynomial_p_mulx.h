...
class LegendrePolynomialPMulxBackward
    : public torch::autograd::Function<LegendrePolynomialPMulxBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_mulx_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_grad_output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_mulx_backward_backward", "")
            .typed<at::Tensor(const at::Tensor&, const at::Tensor&)>()
...
class LegendrePolynomialPMulx
    : public torch::autograd::Function<LegendrePolynomialPMulx> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* ctx,
        const at::Tensor& coeffs
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_coeffs = LegendrePolynomialPMulxBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor legendre_polynomial_p_mulx(const at::Tensor& coeffs) {
    return LegendrePolynomialPMulx::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("legendre_polynomial_p_mulx", &torchscience::autograd::polynomial::legendre_polynomial_p_mulx);
}
