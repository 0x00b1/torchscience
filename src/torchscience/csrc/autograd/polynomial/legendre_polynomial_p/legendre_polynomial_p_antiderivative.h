...
class LegendrePolynomialPAntiderivativeBackward
    : public torch::autograd::Function<LegendrePolynomialPAntiderivativeBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_antiderivative_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_grad_output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_antiderivative_backward_backward", "")
            .typed<at::Tensor(const at::Tensor&, const at::Tensor&)>()
...
class LegendrePolynomialPAntiderivative
    : public torch::autograd::Function<LegendrePolynomialPAntiderivative> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* ctx,
        const at::Tensor& coeffs
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_coeffs = LegendrePolynomialPAntiderivativeBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor legendre_polynomial_p_antiderivative(const at::Tensor& coeffs) {
    return LegendrePolynomialPAntiderivative::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("legendre_polynomial_p_antiderivative", &torchscience::autograd::polynomial::legendre_polynomial_p_antiderivative);
}
