...
class LegendrePolynomialPMultiplyBackward
    : public torch::autograd::Function<LegendrePolynomialPMultiplyBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto [grad_a, grad_b] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_multiply_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, grad_a_from_gg, grad_b_from_gg] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_multiply_backward_backward", "")
...
class LegendrePolynomialPMultiply
    : public torch::autograd::Function<LegendrePolynomialPMultiply> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::legendre_polynomial_p_multiply", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = LegendrePolynomialPMultiplyBackward::apply(
            grad_outputs[0],
            a,
            b,
            a_requires_grad,
...
inline at::Tensor legendre_polynomial_p_multiply(
    ...
    return LegendrePolynomialPMultiply::apply(a, b);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("legendre_polynomial_p_multiply", &torchscience::autograd::polynomial::legendre_polynomial_p_multiply);
}
