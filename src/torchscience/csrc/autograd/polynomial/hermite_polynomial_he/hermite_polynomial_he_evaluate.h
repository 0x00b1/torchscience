...
class HermitePolynomialHeEvaluateBackward
    : public torch::autograd::Function<HermitePolynomialHeEvaluateBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto [grad_coeffs, grad_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hermite_polynomial_he_evaluate_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, g_coeffs, g_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hermite_polynomial_he_evaluate_backward_backward", "")
...
class HermitePolynomialHeEvaluate
    : public torch::autograd::Function<HermitePolynomialHeEvaluate> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hermite_polynomial_he_evaluate", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = HermitePolynomialHeEvaluateBackward::apply(
            grad_outputs[0],
            coeffs,
            x,
...
inline at::Tensor hermite_polynomial_he_evaluate(
    ...
    return HermitePolynomialHeEvaluate::apply(coeffs, x);
}

}  // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("hermite_polynomial_he_evaluate", &torchscience::autograd::polynomial::hermite_polynomial_he_evaluate);
}
