...
class HermitePolynomialHeDerivativeBackward
    : public torch::autograd::Function<HermitePolynomialHeDerivativeBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hermite_polynomial_he_derivative_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_grad_output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hermite_polynomial_he_derivative_backward_backward", "")
            .typed<at::Tensor(const at::Tensor&, const at::Tensor&)>()
...
class HermitePolynomialHeDerivative
    : public torch::autograd::Function<HermitePolynomialHeDerivative> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* ctx,
        const at::Tensor& coeffs
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hermite_polynomial_he_derivative", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_coeffs = HermitePolynomialHeDerivativeBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor hermite_polynomial_he_derivative(const at::Tensor& coeffs) {
    return HermitePolynomialHeDerivative::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("hermite_polynomial_he_derivative", &torchscience::autograd::polynomial::hermite_polynomial_he_derivative);
}
