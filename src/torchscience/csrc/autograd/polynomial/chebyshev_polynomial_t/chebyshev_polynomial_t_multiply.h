...
class ChebyshevPolynomialTMultiplyBackward
    : public torch::autograd::Function<ChebyshevPolynomialTMultiplyBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto [grad_a, grad_b] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_t_multiply_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, grad_a_from_gg, grad_b_from_gg] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_t_multiply_backward_backward", "")
...
class ChebyshevPolynomialTMultiply
    : public torch::autograd::Function<ChebyshevPolynomialTMultiply> {
public:
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = ChebyshevPolynomialTMultiplyBackward::apply(
            grad_outputs[0],
            a,
            b,
            a_requires_grad,
...
inline at::Tensor chebyshev_polynomial_t_multiply(
    ...
    return ChebyshevPolynomialTMultiply::apply(a, b);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_t_multiply", &torchscience::autograd::polynomial::chebyshev_polynomial_t_multiply);
}
