...
class ChebyshevPolynomialTEvaluateBackward
    : public torch::autograd::Function<ChebyshevPolynomialTEvaluateBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto [grad_coeffs, grad_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_t_evaluate_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, g_coeffs, g_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_t_evaluate_backward_backward", "")
...
class ChebyshevPolynomialTEvaluate
    : public torch::autograd::Function<ChebyshevPolynomialTEvaluate> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_t_evaluate", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = ChebyshevPolynomialTEvaluateBackward::apply(
            grad_outputs[0],
            coeffs,
            x,
...
inline at::Tensor chebyshev_polynomial_t_evaluate(
    ...
    return ChebyshevPolynomialTEvaluate::apply(coeffs, x);
}

}  // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_t_evaluate", &torchscience::autograd::polynomial::chebyshev_polynomial_t_evaluate);
}
