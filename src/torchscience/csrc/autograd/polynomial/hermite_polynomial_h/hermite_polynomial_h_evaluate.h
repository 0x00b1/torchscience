...
class HermitePolynomialHEvaluateBackward
    : public torch::autograd::Function<HermitePolynomialHEvaluateBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto [grad_coeffs, grad_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hermite_polynomial_h_evaluate_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, g_coeffs, g_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hermite_polynomial_h_evaluate_backward_backward", "")
...
class HermitePolynomialHEvaluate
    : public torch::autograd::Function<HermitePolynomialHEvaluate> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hermite_polynomial_h_evaluate", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = HermitePolynomialHEvaluateBackward::apply(
            grad_outputs[0],
            coeffs,
            x,
...
inline at::Tensor hermite_polynomial_h_evaluate(
    ...
    return HermitePolynomialHEvaluate::apply(coeffs, x);
}

}  // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("hermite_polynomial_h_evaluate", &torchscience::autograd::polynomial::hermite_polynomial_h_evaluate);
}
