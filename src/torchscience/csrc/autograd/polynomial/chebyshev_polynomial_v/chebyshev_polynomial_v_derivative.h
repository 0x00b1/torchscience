...
class ChebyshevPolynomialVDerivativeBackward
    : public torch::autograd::Function<ChebyshevPolynomialVDerivativeBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_derivative_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_grad_output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_derivative_backward_backward", "")
            .typed<at::Tensor(const at::Tensor&, const at::Tensor&)>()
...
class ChebyshevPolynomialVDerivative
    : public torch::autograd::Function<ChebyshevPolynomialVDerivative> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* ctx,
        const at::Tensor& coeffs
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_derivative", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_coeffs = ChebyshevPolynomialVDerivativeBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor chebyshev_polynomial_v_derivative(const at::Tensor& coeffs) {
    return ChebyshevPolynomialVDerivative::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_v_derivative", &torchscience::autograd::polynomial::chebyshev_polynomial_v_derivative);
}
