...
class ChebyshevPolynomialVMulxBackward
    : public torch::autograd::Function<ChebyshevPolynomialVMulxBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto grad_coeffs = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_mulx_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, grad_coeffs_from_gg] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_mulx_backward_backward", "")
...
class ChebyshevPolynomialVMulx
    : public torch::autograd::Function<ChebyshevPolynomialVMulx> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_mulx", "")
            .typed<at::Tensor(
                const at::Tensor&
            )>()
            .call(coeffs);
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = ChebyshevPolynomialVMulxBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor chebyshev_polynomial_v_mulx(
    ...
    return ChebyshevPolynomialVMulx::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_v_mulx", &torchscience::autograd::polynomial::chebyshev_polynomial_v_mulx);
}
