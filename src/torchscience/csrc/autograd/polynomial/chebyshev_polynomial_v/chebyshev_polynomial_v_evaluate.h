...
class ChebyshevPolynomialVEvaluateBackward
    : public torch::autograd::Function<ChebyshevPolynomialVEvaluateBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto [grad_coeffs, grad_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_evaluate_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, g_coeffs, g_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_evaluate_backward_backward", "")
...
class ChebyshevPolynomialVEvaluate
    : public torch::autograd::Function<ChebyshevPolynomialVEvaluate> {
public:
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = ChebyshevPolynomialVEvaluateBackward::apply(
            grad_outputs[0],
            coeffs,
            x,
...
inline at::Tensor chebyshev_polynomial_v_evaluate(
    ...
    return ChebyshevPolynomialVEvaluate::apply(coeffs, x);
}

}  // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_v_evaluate", &torchscience::autograd::polynomial::chebyshev_polynomial_v_evaluate);
}
