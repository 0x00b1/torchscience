...
class ChebyshevPolynomialVAntiderivativeBackward
    : public torch::autograd::Function<ChebyshevPolynomialVAntiderivativeBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto grad_coeffs = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_antiderivative_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grad_grad_output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_antiderivative_backward_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                const at::Tensor&
...
class ChebyshevPolynomialVAntiderivative
    : public torch::autograd::Function<ChebyshevPolynomialVAntiderivative> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_v_antiderivative", "")
            .typed<at::Tensor(
                const at::Tensor&
            )>()
            .call(coeffs);
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = ChebyshevPolynomialVAntiderivativeBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor chebyshev_polynomial_v_antiderivative(
    ...
    return ChebyshevPolynomialVAntiderivative::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_v_antiderivative", &torchscience::autograd::polynomial::chebyshev_polynomial_v_antiderivative);
}
