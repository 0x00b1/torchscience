...
class ChebyshevPolynomialWAntiderivativeBackward
    : public torch::autograd::Function<ChebyshevPolynomialWAntiderivativeBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto grad_coeffs = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_w_antiderivative_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grad_grad_output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_w_antiderivative_backward_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                const at::Tensor&
...
class ChebyshevPolynomialWAntiderivative
    : public torch::autograd::Function<ChebyshevPolynomialWAntiderivative> {
public:
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = ChebyshevPolynomialWAntiderivativeBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor chebyshev_polynomial_w_antiderivative(
    ...
    return ChebyshevPolynomialWAntiderivative::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_w_antiderivative", &torchscience::autograd::polynomial::chebyshev_polynomial_w_antiderivative);
}
