...
class ChebyshevPolynomialWMulxBackward
    : public torch::autograd::Function<ChebyshevPolynomialWMulxBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto grad_coeffs = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_w_mulx_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, grad_coeffs_from_gg] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_w_mulx_backward_backward", "")
...
class ChebyshevPolynomialWMulx
    : public torch::autograd::Function<ChebyshevPolynomialWMulx> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_w_mulx", "")
            .typed<at::Tensor(
                const at::Tensor&
            )>()
            .call(coeffs);
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = ChebyshevPolynomialWMulxBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor chebyshev_polynomial_w_mulx(
    ...
    return ChebyshevPolynomialWMulx::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_w_mulx", &torchscience::autograd::polynomial::chebyshev_polynomial_w_mulx);
}
