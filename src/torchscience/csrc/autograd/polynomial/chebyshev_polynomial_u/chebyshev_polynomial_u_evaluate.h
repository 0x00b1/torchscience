...
class ChebyshevPolynomialUEvaluateBackward
    : public torch::autograd::Function<ChebyshevPolynomialUEvaluateBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto [grad_coeffs, grad_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_u_evaluate_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, g_coeffs, g_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_u_evaluate_backward_backward", "")
...
class ChebyshevPolynomialUEvaluate
    : public torch::autograd::Function<ChebyshevPolynomialUEvaluate> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_u_evaluate", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = ChebyshevPolynomialUEvaluateBackward::apply(
            grad_outputs[0],
            coeffs,
            x,
...
inline at::Tensor chebyshev_polynomial_u_evaluate(
    ...
    return ChebyshevPolynomialUEvaluate::apply(coeffs, x);
}

}  // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_u_evaluate", &torchscience::autograd::polynomial::chebyshev_polynomial_u_evaluate);
}
