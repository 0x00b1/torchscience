...
class ChebyshevPolynomialUAntiderivativeBackward
    : public torch::autograd::Function<ChebyshevPolynomialUAntiderivativeBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto grad_coeffs = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_u_antiderivative_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grad_grad_output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_u_antiderivative_backward_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                const at::Tensor&
...
class ChebyshevPolynomialUAntiderivative
    : public torch::autograd::Function<ChebyshevPolynomialUAntiderivative> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::chebyshev_polynomial_u_antiderivative", "")
            .typed<at::Tensor(
                const at::Tensor&
            )>()
            .call(coeffs);
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = ChebyshevPolynomialUAntiderivativeBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor chebyshev_polynomial_u_antiderivative(
    ...
    return ChebyshevPolynomialUAntiderivative::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("chebyshev_polynomial_u_antiderivative", &torchscience::autograd::polynomial::chebyshev_polynomial_u_antiderivative);
}
