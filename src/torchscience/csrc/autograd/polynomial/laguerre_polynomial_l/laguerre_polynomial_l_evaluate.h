...
class LaguerrePolynomialLEvaluateBackward
    : public torch::autograd::Function<LaguerrePolynomialLEvaluateBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto [grad_coeffs, grad_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::laguerre_polynomial_l_evaluate_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, g_coeffs, g_x] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::laguerre_polynomial_l_evaluate_backward_backward", "")
...
class LaguerrePolynomialLEvaluate
    : public torch::autograd::Function<LaguerrePolynomialLEvaluate> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::laguerre_polynomial_l_evaluate", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = LaguerrePolynomialLEvaluateBackward::apply(
            grad_outputs[0],
            coeffs,
            x,
...
inline at::Tensor laguerre_polynomial_l_evaluate(
    ...
    return LaguerrePolynomialLEvaluate::apply(coeffs, x);
}

}  // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("laguerre_polynomial_l_evaluate", &torchscience::autograd::polynomial::laguerre_polynomial_l_evaluate);
}
