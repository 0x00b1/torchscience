...
class PolynomialDerivativeBackward
    : public torch::autograd::Function<PolynomialDerivativeBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::polynomial_derivative_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_grad_output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::polynomial_derivative_backward_backward", "")
            .typed<at::Tensor(const at::Tensor&, const at::Tensor&)>()
...
class PolynomialDerivative
    : public torch::autograd::Function<PolynomialDerivative> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* ctx,
        const at::Tensor& coeffs
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::polynomial_derivative", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_coeffs = PolynomialDerivativeBackward::apply(
            grad_outputs[0],
            coeffs,
...
inline at::Tensor polynomial_derivative(const at::Tensor& coeffs) {
    return PolynomialDerivative::apply(coeffs);
}

} // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("polynomial_derivative", &torchscience::autograd::polynomial::polynomial_derivative);
}
