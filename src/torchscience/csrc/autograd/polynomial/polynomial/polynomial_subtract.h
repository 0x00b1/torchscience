...
class PolynomialSubtractBackward
    : public torch::autograd::Function<PolynomialSubtractBackward> {
public:
    static std::vector<at::Tensor> forward(
        ...
        auto [grad_p, grad_q] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::polynomial_subtract_backward", "")
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, g_p, g_q] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::polynomial_subtract_backward_backward", "")
...
class PolynomialSubtract
    : public torch::autograd::Function<PolynomialSubtract> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::polynomial_subtract", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&
            )>()
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto grads = PolynomialSubtractBackward::apply(
            grad_outputs[0],
            p,
            q,
            p_requires_grad,
...
inline at::Tensor polynomial_subtract(
    const at::Tensor& p,
    const at::Tensor& q
) {
    return PolynomialSubtract::apply(p, q);
}

}  // namespace torchscience::autograd::polynomial

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("polynomial_subtract", &torchscience::autograd::polynomial::polynomial_subtract);
}
