...
class BinomialLogProbabilityMassFunction : public torch::autograd::Function<BinomialLogProbabilityMassFunction> {
public:
  static at::Tensor forward(
      torch::autograd::AutogradContext* ctx,
      const at::Tensor& k,
    ...
    return c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::binomial_log_probability_mass", "")
        .typed<at::Tensor(const at::Tensor&, const at::Tensor&, const at::Tensor&)>()
        .call(k, n, p);
  }
  ...
  static std::vector<at::Tensor> backward(
    ...
    auto result = c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::binomial_log_probability_mass_backward", "")
        .typed<std::tuple<at::Tensor, at::Tensor, at::Tensor>(
            const at::Tensor&, const at::Tensor&, const at::Tensor&, const at::Tensor&)>()
        .call(grad_output, k, n, p);
...
inline at::Tensor binomial_log_probability_mass(
    const at::Tensor& k,
    const at::Tensor& n,
    const at::Tensor& p
) {
  return BinomialLogProbabilityMassFunction::apply(k, n, p);
}

class BinomialSurvivalFunction : public torch::autograd::Function<BinomialSurvivalFunction> {
public:
  static at::Tensor forward(
      torch::autograd::AutogradContext* ctx,
      const at::Tensor& k,
    ...
    return c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::binomial_survival", "")
        .typed<at::Tensor(const at::Tensor&, const at::Tensor&, const at::Tensor&)>()
        .call(k, n, p);
  }
  ...
  static std::vector<at::Tensor> backward(
    ...
    auto result = c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::binomial_survival_backward", "")
        .typed<std::tuple<at::Tensor, at::Tensor, at::Tensor>(
            const at::Tensor&, const at::Tensor&, const at::Tensor&, const at::Tensor&)>()
        .call(grad_output, k, n, p);
...
inline at::Tensor binomial_survival(
    const at::Tensor& k,
    const at::Tensor& n,
    const at::Tensor& p
) {
  return BinomialSurvivalFunction::apply(k, n, p);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
  ...
  m.impl("binomial_log_probability_mass", &torchscience::autograd::probability::binomial_log_probability_mass);
  m.impl("binomial_probability_mass", &torchscience::autograd::probability::binomial_probability_mass);
  m.impl("binomial_survival", &torchscience::autograd::probability::binomial_survival);
}
