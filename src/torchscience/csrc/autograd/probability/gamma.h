...
class GammaLogPdfFunction : public torch::autograd::Function<GammaLogPdfFunction> {
public:
  static at::Tensor forward(
      torch::autograd::AutogradContext* ctx,
      const at::Tensor& x,
    ...
    return c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::gamma_log_probability_density", "")
        .typed<at::Tensor(const at::Tensor&, const at::Tensor&, const at::Tensor&)>()
        .call(x, shape, scale);
  }
  ...
  static std::vector<at::Tensor> backward(
    ...
    auto result = c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::gamma_log_probability_density_backward", "")
        .typed<std::tuple<at::Tensor, at::Tensor, at::Tensor>(
            const at::Tensor&, const at::Tensor&, const at::Tensor&, const at::Tensor&)>()
        .call(grad_output, x, shape, scale);
...
inline at::Tensor gamma_log_probability_density(
    const at::Tensor& x,
    const at::Tensor& shape,
    const at::Tensor& scale
) {
