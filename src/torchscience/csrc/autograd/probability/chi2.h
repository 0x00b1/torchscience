...
/**
 * Autograd function for chi2 log PDF.
 */
class Chi2LogPdfFunction : public torch::autograd::Function<Chi2LogPdfFunction> {
public:
  static at::Tensor forward(
      torch::autograd::AutogradContext* ctx,
      const at::Tensor& x,
    ...
    return c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::chi2_log_probability_density", "")
        .typed<at::Tensor(const at::Tensor&, const at::Tensor&)>()
        .call(x, df);
  }
  ...
  static std::vector<at::Tensor> backward(
    ...
    auto result = c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::chi2_log_probability_density_backward", "")
        .typed<std::tuple<at::Tensor, at::Tensor>(
            const at::Tensor&, const at::Tensor&, const at::Tensor&)>()
        .call(grad_output, x, df);
...
inline at::Tensor chi2_log_probability_density(
    const at::Tensor& x,
    const at::Tensor& df
) {
  return Chi2LogPdfFunction::apply(x, df);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
  ...
  m.impl("chi2_log_probability_density", &torchscience::autograd::probability::chi2_log_probability_density);
}
