...
class PoissonLogProbabilityMassFunction : public torch::autograd::Function<PoissonLogProbabilityMassFunction> {
public:
  static at::Tensor forward(
      torch::autograd::AutogradContext* ctx,
      const at::Tensor& k,
    ...
    return c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::poisson_log_probability_mass", "")
        .typed<at::Tensor(const at::Tensor&, const at::Tensor&)>()
        .call(k, rate);
  }
  ...
  static std::vector<at::Tensor> backward(
    ...
    auto result = c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::poisson_log_probability_mass_backward", "")
        .typed<std::tuple<at::Tensor, at::Tensor>(
            const at::Tensor&, const at::Tensor&, const at::Tensor&)>()
        .call(grad_output, k, rate);
...
inline at::Tensor poisson_log_probability_mass(
    const at::Tensor& k,
    const at::Tensor& rate
) {
  return PoissonLogProbabilityMassFunction::apply(k, rate);
}

class PoissonSurvivalFunction : public torch::autograd::Function<PoissonSurvivalFunction> {
public:
  static at::Tensor forward(
      torch::autograd::AutogradContext* ctx,
      const at::Tensor& k,
    ...
    return c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::poisson_survival", "")
        .typed<at::Tensor(const at::Tensor&, const at::Tensor&)>()
        .call(k, rate);
  }
  ...
  static std::vector<at::Tensor> backward(
    ...
    auto result = c10::Dispatcher::singleton()
        .findSchemaOrThrow("torchscience::poisson_survival_backward", "")
        .typed<std::tuple<at::Tensor, at::Tensor>(
            const at::Tensor&, const at::Tensor&, const at::Tensor&)>()
        .call(grad_output, k, rate);
...
inline at::Tensor poisson_survival(
    const at::Tensor& k,
    const at::Tensor& rate
) {
  return PoissonSurvivalFunction::apply(k, rate);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
  ...
  m.impl("poisson_log_probability_mass", &torchscience::autograd::probability::poisson_log_probability_mass);
  m.impl("poisson_probability_mass", &torchscience::autograd::probability::poisson_probability_mass);
  m.impl("poisson_survival", &torchscience::autograd::probability::poisson_survival);
}
