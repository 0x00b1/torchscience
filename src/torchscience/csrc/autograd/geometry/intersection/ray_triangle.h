// src/torchscience/csrc/autograd/geometry/intersection/ray_triangle.h
#pragma once
...
/**
 * Autograd function for ray-triangle intersection.
 *
 * Computes the intersection of rays with triangles using the
 * Moller-Trumbore algorithm.
 */
class RayTriangleFunction : public torch::autograd::Function<RayTriangleFunction> {
 public:
  static std::vector<at::Tensor> forward(
      ...
      const at::Tensor& v1,
      const at::Tensor& v2) {
    ctx->save_for_backward({origins, directions, v0, v1, v2});

    at::AutoDispatchBelowAutograd guard;

    auto result = c10::Dispatcher::singleton()
                      .findSchemaOrThrow("torchscience::ray_triangle", "")
                      .typed<std::tuple<
                          at::Tensor,
                          at::Tensor,
                          at::Tensor,
                          ...
                          const at::Tensor&,
                          const at::Tensor&)>()
                      .call(origins, directions, v0, v1, v2);
  ...
  static std::vector<at::Tensor> backward(
    ...
    at::Tensor v0 = saved[2];
    at::Tensor v1 = saved[3];
    at::Tensor v2 = saved[4];
    ...
    auto result =
        c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::ray_triangle_backward", "")
    ...
    return {
        ...
        std::get<2>(result), // grad_v0
        std::get<3>(result), // grad_v1
        std::get<4>(result)  // grad_v2
    };
  }
};
...
ray_triangle(
    ...
    const at::Tensor& v1,
    const at::Tensor& v2) {
  auto result = RayTriangleFunction::apply(
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
  m.impl(
      "ray_triangle",
      &torchscience::autograd::geometry::intersection::ray_triangle);
}
