// src/torchscience/csrc/autograd/geometry/intersection/ray_sphere.h
#pragma once
...
/**
 * Autograd function for ray-sphere intersection.
 *
 * Computes the intersection of rays with spheres.
 */
class RaySphereFunction : public torch::autograd::Function<RaySphereFunction> {
 public:
  static std::vector<at::Tensor> forward(
    ...
    ctx->save_for_backward({origins, directions, centers, radii});

    at::AutoDispatchBelowAutograd guard;

    auto result = c10::Dispatcher::singleton()
                      .findSchemaOrThrow("torchscience::ray_sphere", "")
                      .typed<std::tuple<
                          at::Tensor,
                          at::Tensor,
                          at::Tensor,
                          ...
                          const at::Tensor&,
                          const at::Tensor&)>()
                      .call(origins, directions, centers, radii);
  ...
  static std::vector<at::Tensor> backward(
    ...
    at::Tensor centers = saved[2];
    at::Tensor radii = saved[3];
    ...
    auto result =
        c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::ray_sphere_backward", "")
    ...
    return {
        ...
        std::get<2>(result), // grad_centers
        std::get<3>(result)  // grad_radii
    };
  }
};
...
ray_sphere(
    ...
    const at::Tensor& centers,
    const at::Tensor& radii) {
  auto result = RaySphereFunction::apply(
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
  m.impl(
      "ray_sphere",
      &torchscience::autograd::geometry::intersection::ray_sphere);
}
