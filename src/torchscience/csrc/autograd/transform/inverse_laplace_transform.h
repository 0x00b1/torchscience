...
class InverseLaplaceTransformBackward
    : public torch::autograd::Function<InverseLaplaceTransformBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::inverse_laplace_transform_backward", "")
            .typed<at::Tensor(
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, new_grad_input] =
            ...
            .findSchemaOrThrow("torchscience::inverse_laplace_transform_backward_backward", "")
...
class InverseLaplaceTransform
    : public torch::autograd::Function<InverseLaplaceTransform> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* context,
        const at::Tensor& input,
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::inverse_laplace_transform", "")
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_input = InverseLaplaceTransformBackward::apply(
...
inline at::Tensor inverse_laplace_transform(
    ...
    return InverseLaplaceTransform::apply(input, t_out, s_in, dim, sigma, integration_method);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, module) {
    module.impl(
        ...
        &torchscience::autograd::transform::inverse_laplace_transform
    );
}
