...
class AbelTransformBackward
    : public torch::autograd::Function<AbelTransformBackward> {
public:
    static at::Tensor forward(
        ...
        context->save_for_backward({grad_output, input, y_out, r_in});
        ...
        return c10::Dispatcher::singleton()
            ...
            .call(grad_output, input, y_out, r_in, dim, integration_method);
    }
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, new_grad_input] =
            ...
            .findSchemaOrThrow("torchscience::abel_transform_backward_backward", "")
            .typed<std::tuple<at::Tensor, at::Tensor>(
                const at::Tensor&, const at::Tensor&, const at::Tensor&,
                const at::Tensor&, const at::Tensor&, int64_t, int64_t
            )>()
            .call(grad_grad_input, grad_output, input, y_out, r_in, dim, integration_method);
...
class AbelTransform
    : public torch::autograd::Function<AbelTransform> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* context,
        const at::Tensor& input,
        ...
        context->save_for_backward({input, y_out, r_in});
        context->saved_data["dim"] = dim;
        context->saved_data["integration_method"] = integration_method;
        ...
        return c10::Dispatcher::singleton()
            ...
            .typed<at::Tensor(const at::Tensor&, const at::Tensor&,
                const at::Tensor&, int64_t, int64_t)>()
            .call(input, y_out, r_in, dim, integration_method);
    }
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_input = AbelTransformBackward::apply(
            grad_output, input, y_out, r_in, dim, integration_method, input_requires_grad
        );
...
inline at::Tensor abel_transform(
    ...
    return AbelTransform::apply(input, y_out, r_in, dim, integration_method);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, module) {
    module.impl(
        "abel_transform",
        &torchscience::autograd::transform::abel_transform
    );
}
