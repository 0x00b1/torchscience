...
class InverseMellinTransformBackward
    : public torch::autograd::Function<InverseMellinTransformBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            ...
            .call(grad_output, input, t_out, s_in, dim, c, integration_method);
    }
    ...
    static std::vector<at::Tensor> backward(
        ...
        double c = context->saved_data["c"].toDouble();
        ...
        auto [grad_grad_output, new_grad_input] =
            ...
            .findSchemaOrThrow("torchscience::inverse_mellin_transform_backward_backward", "")
            .typed<std::tuple<at::Tensor, at::Tensor>(
                const at::Tensor&, const at::Tensor&, const at::Tensor&,
                const at::Tensor&, const at::Tensor&, int64_t, double, int64_t
            )>()
            .call(grad_grad_input, grad_output, input, t_out, s_in, dim, c, integration_method);
...
class InverseMellinTransform
    : public torch::autograd::Function<InverseMellinTransform> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* context,
        const at::Tensor& input,
        ...
        return c10::Dispatcher::singleton()
            ...
            .typed<at::Tensor(const at::Tensor&, const at::Tensor&,
                const at::Tensor&, int64_t, double, int64_t)>()
            .call(input, t_out, s_in, dim, c, integration_method);
    }
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_input = InverseMellinTransformBackward::apply(
            grad_output, input, t_out, s_in, dim, c, integration_method, input_requires_grad
        );
...
inline at::Tensor inverse_mellin_transform(
    ...
    return InverseMellinTransform::apply(input, t_out, s_in, dim, c, integration_method);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, module) {
    module.impl(
        ...
        &torchscience::autograd::transform::inverse_mellin_transform
    );
}
