...
class TwoSidedLaplaceTransformBackward
    : public torch::autograd::Function<TwoSidedLaplaceTransformBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::two_sided_laplace_transform_backward", "")
            .typed<at::Tensor(
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, new_grad_input] =
            ...
            .findSchemaOrThrow("torchscience::two_sided_laplace_transform_backward_backward", "")
...
class TwoSidedLaplaceTransform
    : public torch::autograd::Function<TwoSidedLaplaceTransform> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* context,
        const at::Tensor& input,
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::two_sided_laplace_transform", "")
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_input = TwoSidedLaplaceTransformBackward::apply(
...
inline at::Tensor two_sided_laplace_transform(
    ...
    return TwoSidedLaplaceTransform::apply(input, s, t, dim, integration_method);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, module) {
    module.impl(
        ...
        &torchscience::autograd::transform::two_sided_laplace_transform
    );
}
