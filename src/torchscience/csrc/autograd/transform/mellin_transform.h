...
class MellinTransformBackward
    : public torch::autograd::Function<MellinTransformBackward> {
public:
    static at::Tensor forward(
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::mellin_transform_backward", "")
            .typed<at::Tensor(
    ...
    static std::vector<at::Tensor> backward(
        ...
        auto [grad_grad_output, new_grad_input] =
            ...
            .findSchemaOrThrow("torchscience::mellin_transform_backward_backward", "")
...
class MellinTransform
    : public torch::autograd::Function<MellinTransform> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* context,
        const at::Tensor& input,
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::mellin_transform", "")
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_input = MellinTransformBackward::apply(
...
inline at::Tensor mellin_transform(
    ...
    return MellinTransform::apply(input, s, t, dim, integration_method);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, module) {
    module.impl(
        "mellin_transform",
        &torchscience::autograd::transform::mellin_transform
    );
}
