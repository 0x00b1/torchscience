...
class HankelTransformBackward
    : public torch::autograd::Function<HankelTransformBackward> {
public:
    static at::Tensor forward(
        ...
        context->save_for_backward({grad_output, input, k_out, r_in});
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hankel_transform_backward", "")
            .typed<at::Tensor(
                const at::Tensor&, const at::Tensor&, const at::Tensor&,
                const at::Tensor&, int64_t, double, int64_t
            )>()
            .call(grad_output, input, k_out, r_in, dim, order, integration_method);
    }
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor k_out = saved[2];
        at::Tensor r_in = saved[3];
        ...
        auto [grad_grad_output, new_grad_input] =
            ...
            .findSchemaOrThrow("torchscience::hankel_transform_backward_backward", "")
            .typed<std::tuple<at::Tensor, at::Tensor>(
                const at::Tensor&, const at::Tensor&, const at::Tensor&,
                const at::Tensor&, const at::Tensor&, int64_t, double, int64_t
            )>()
            .call(grad_grad_input, grad_output, input, k_out, r_in, dim, order, integration_method);
...
class HankelTransform
    : public torch::autograd::Function<HankelTransform> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* context,
        const at::Tensor& input,
        ...
        context->save_for_backward({input, k_out, r_in});
        context->saved_data["dim"] = dim;
        context->saved_data["order"] = order;
        context->saved_data["integration_method"] = integration_method;
        ...
        return c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::hankel_transform", "")
            .typed<at::Tensor(const at::Tensor&, const at::Tensor&,
                const at::Tensor&, int64_t, double, int64_t)>()
            .call(input, k_out, r_in, dim, order, integration_method);
    }
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor k_out = saved[1];
        at::Tensor r_in = saved[2];
        ...
        at::Tensor grad_input = HankelTransformBackward::apply(
            grad_output, input, k_out, r_in, dim, order, integration_method, input_requires_grad
        );
...
inline at::Tensor hankel_transform(
    ...
    return HankelTransform::apply(input, k_out, r_in, dim, order, integration_method);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, module) {
    module.impl(
        "hankel_transform",
        &torchscience::autograd::transform::hankel_transform
    );
}
