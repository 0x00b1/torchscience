...
/**
 * Autograd function for erosion.
 */
class ErosionFunction : public torch::autograd::Function<ErosionFunction> {
public:
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::Tensor grad_input = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::erosion_backward", "")
...
inline at::Tensor erosion(
    ...
    return ErosionFunction::apply(input, structuring_element, origin, padding_mode);
}

}  // namespace torchscience::autograd::morphology

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("erosion", &torchscience::autograd::morphology::erosion);
}
