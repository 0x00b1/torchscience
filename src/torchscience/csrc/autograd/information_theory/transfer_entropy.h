...
class TransferEntropyFunction
    : public torch::autograd::Function<TransferEntropyFunction> {
public:
    static at::Tensor forward(
        ...
        at::Tensor output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::transfer_entropy", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const std::string&,
                const std::string&,
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_joint = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::transfer_entropy_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                const std::string&,
...
inline at::Tensor transfer_entropy(
    ...
    return TransferEntropyFunction::apply(
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("transfer_entropy", &torchscience::autograd::information_theory::transfer_entropy);
}
