...
class DualTotalCorrelationFunction
    : public torch::autograd::Function<DualTotalCorrelationFunction> {
public:
    static at::Tensor forward(
        ...
        at::Tensor output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::dual_total_correlation", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const std::string&,
                const std::string&,
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_joint = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::dual_total_correlation_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                const std::string&,
...
inline at::Tensor dual_total_correlation(
    ...
    return DualTotalCorrelationFunction::apply(
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("dual_total_correlation", &torchscience::autograd::information_theory::dual_total_correlation);
}
