...
class CausallyConditionedEntropyFunction
    : public torch::autograd::Function<CausallyConditionedEntropyFunction> {
public:
    static at::Tensor forward(
        ...
        at::Tensor output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::causally_conditioned_entropy", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const std::string&,
                const std::string&,
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_joint = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::causally_conditioned_entropy_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                const std::string&,
...
inline at::Tensor causally_conditioned_entropy(
    ...
    return CausallyConditionedEntropyFunction::apply(
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("causally_conditioned_entropy", &torchscience::autograd::information_theory::causally_conditioned_entropy);
}
