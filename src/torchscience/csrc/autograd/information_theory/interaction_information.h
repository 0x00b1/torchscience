...
class InteractionInformationFunction
    : public torch::autograd::Function<InteractionInformationFunction> {
public:
    static at::Tensor forward(
        ...
        at::Tensor output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::interaction_information", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const std::string&,
                const std::string&,
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_joint = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::interaction_information_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                const std::string&,
...
inline at::Tensor interaction_information(
    ...
    return InteractionInformationFunction::apply(
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("interaction_information", &torchscience::autograd::information_theory::interaction_information);
}
