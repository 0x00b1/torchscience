...
class TotalCorrelationFunction
    : public torch::autograd::Function<TotalCorrelationFunction> {
public:
    static at::Tensor forward(
        ...
        at::Tensor output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::total_correlation", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const std::string&,
                const std::string&,
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_joint = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::total_correlation_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                const std::string&,
...
inline at::Tensor total_correlation(
    ...
    return TotalCorrelationFunction::apply(
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("total_correlation", &torchscience::autograd::information_theory::total_correlation);
}
