...
def is_compile_compatible(solver: Callable) -> bool:
    ...
    Examples
    --------
    >>> from torchscience.ordinary_differential_equation.initial_value_problem import euler, dormand_prince_5
...
def compile_solver(
    ...
    *,
    ...
    Examples
    --------
    >>> from torchscience.ordinary_differential_equation.initial_value_problem import euler
    >>> from torchscience.ordinary_differential_equation._compile_utils import (
    ...     compile_solver,
    ... )
