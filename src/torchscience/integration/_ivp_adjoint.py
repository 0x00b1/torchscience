...
from torchscience.integration._implicit_adjoint import (
    bdf1_adjoint_step,
)
from torchscience.integration._sparse_jacobian import (
    ...
    def forward(
        ...
        *params : Tensors
        ...
        y_final_flat : Tensor
            Flattened final state
        """
        from torchscience.integration._checkpointing import (
