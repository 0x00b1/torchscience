...
def polynomial_to_laguerre_polynomial_l(
    ...
    >>> c  # x^2 = 2 - 4*L_1 + 2*L_2 = 2*L_0 - 4*L_1 + 2*L_2
    LaguerrePolynomialL(tensor([ 2., -4.,  2.]))
    """
    ...
    result = laguerre_polynomial_l(coeffs[..., -1:].clone())
    ...
    for i in range(n - 2, -1, -1):
        ...
        result = laguerre_polynomial_l_add(
            result, laguerre_polynomial_l(coeffs[..., i : i + 1].clone())
        )
